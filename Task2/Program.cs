...
{
int[,] newArray = new int[array.GetLength(0), array.GetLength(1)]; // создадим новый массив
...
Console.WriteLine();
if (Test(anyArray)) // если Test верен то запустим ChangeArray и здесь же в if распечатаем
{
...
{
Console.WriteLine(" Стороны не совпадают "); // в ином случае выведем сообщение
}